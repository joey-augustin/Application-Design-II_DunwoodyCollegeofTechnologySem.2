...
- Polymorphism through shared method names across classes
- Using Scanner for user input
- Working with different numeric data types (int vs double)
- Validating conditions within methods (Square requiring equal sides)
